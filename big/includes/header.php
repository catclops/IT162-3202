...
<main class="wrapper">
<header>
  <h1><a href="index.php"><i class="logo fa <?=$logo?>"></i>Vu Nguyen - BIG Project</a></h1>
<nav id="cssmenu">
<ul>
     <li><a href="../index.php"><span><i class="fa fa-fw fa-home"></i> IT162 Home</span></a></li>
     ...
     <li><a href="siteapp.php"><span><i class="fa fa-fw fa-mobile"></i> Site vs App</span></a></li>
